      ...
      <div class="col-md-3">
        ...
        <div class="box box-primary">
          <div class="box-body box-profile">
            <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url('./assets/adminlte/dist/img/user_img.png'); ?>" alt="User profile picture">
            ...
            <ul class="list-group list-group-unbordered">
              <li class="list-group-item">
                <b>Alamat</b> <a class="pull-right"><?php echo $this->session->userdata['address']; ?></a>
              </li>
            </ul>
